...
import { blackA, red, mauve, violet, slate, green } from "@radix-ui/colors";
  ...
  return (
    <Toast.Provider swipeDirection="right">
      ...
      <ToastRoot open={open} onOpenChange={setOpen}>
        <ToastTitle>Adicionado aos favoritos!</ToastTitle>
...
const ToggleRoot = styled(Toggle.Root, {
  ...
  "&:hover": { backgroundColor: violet.red8 },
  "&[data-state=on]": { backgroundColor: red.red9 },
});
